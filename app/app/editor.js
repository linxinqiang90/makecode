    ...
    (function (editor) {
      ...
      */
            ...
            */
            ...
            // math_number_minmax
            pxt.U.toArray(dom.querySelectorAll("block[type=math_number_minmax]"))
                .concat(pxt.U.toArray(dom.querySelectorAll("shadow[type=math_number_minmax]")))
                .forEach(function (node) {
                // Change the name of the NUM field to SLIDER
                var numField = getField(node, "NUM");
                if (numField) {
